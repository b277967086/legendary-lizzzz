 ...
 */
package com.good.diaodiaode.tebiediao.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    @Override
    public View getItem(int index, View convertView, ViewGroup parent, int tag) {
        CharSequence text;
        ...
        if (index >= 0 && index < getItemsCount()) {
            if (convertView == null) {
                ...
                viewHolder.textView = getTextView(convertView, itemTextResourceId);
                convertView.setTag(viewHolder);

                //设置TextView的属性
                if (itemResourceId == TEXT_VIEW_ITEM_RESOURCE) {
                    configureTextView(viewHolder.textView);
                }
            }else {

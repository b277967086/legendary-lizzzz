...
package com.good.diaodiaode.tebiediao.wheel;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
        ...
        defaultSize = DefaultConfig.TV_SIZE;
        selectorSize = DefaultConfig.TV_SIZE;
    }
    ...
    public void setConfig(PickerConfig config) {
        ...
        defaultSize = config.mWheelTVSize;
        selectorSize = config.mWheelTVSelectorSize;
    }

    /**
     * @param tag -->0 年月日, ---1 上午,下午
     */
...
//        centerDrawable.draw(canvas);
    ...
    private View getItemView(int index) {
        ...
        View view = viewAdapter.getItem(index, recycle.getItem(), itemsLayout, tag);
